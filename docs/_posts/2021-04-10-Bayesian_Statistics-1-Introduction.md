...
![garden of forking data]({{ '/assets/pics/bayesian-statistics/garden_of_forking_data.png' | relative_url }}){: style="width: 70%;" class="left"}
...
![garden of forking data updating]({{ '/assets/pics/bayesian-statistics/garden_of_forking_data_updating.png' | relative_url }}){: style="width: 70%;" class="left"}
